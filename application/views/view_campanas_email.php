                      ...
                      if (!empty($campanas)) {
                        foreach ($campanas as $fila) {
                          ...
                          <tr>
                            ...
                            <td class="text-center"><?php echo ($fila->cant_correo); ?>
                            ...
                            <a href="<?php echo base_url(); ?>index.php/email/config_correos/<?php echo $fila->id; ?>">
                                ...
                                <a href="<?php echo base_url(); ?>index.php/email/edita_campana/<?php echo $fila->id; ?>">
                                    <img width="5%"  src="<?php echo base_url(); ?>images/editar.png" alt="editar">
                                </a>
                                <a href="<?php echo base_url(); ?>index.php/email/elimina_campana/<?php echo $fila->id; ?>">
                                    <img width="5%" src="<?php echo base_url(); ?>images/eliminar.png" alt="editar">
                                </a>    
                            </td>
